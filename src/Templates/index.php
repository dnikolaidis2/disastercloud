    ...
    <div class="row justify-content-center">
      ...
      <div class="col-10">
        <ul class="nav nav-tabs nav-fill justify-content-center">
          <li class="nav-item">
            <a class="nav-link <?php if ($login['active']) { echo "active"; }?>" id="login-tab" data-toggle="tab" href="#login" role="tab" aria-controls="login" aria-selected="false">Log In</a>
          </li>
          <li class="nav-item">
            <a class="nav-link <?php if ($signup['active']) { echo "active"; }?>" id="signup-tab" data-toggle="tab" href="#signup" role="tab" aria-controls="signup" aria-selected="true">Sign Up</a>
          </li>
        </ul>
        <div class="tab-content">
          <div class="tab-pane fade <?php if ($login['active']) { echo "show active"; }?>" id="login" role="tabpanel" aria-labelledby="login-tab">
          ...
          <div class="tab-pane fade <?php if ($signup['active']) { echo "show active"; }?>" id="signup" role="tabpanel" aria-labelledby="signup-tab">
            <form method="post" action="index.php">
