...
<head>
    ...
    <title>Edit student · Disastercloud</title>
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <?php if(isset($name_error)): ?>
                                    is-invalid
                                <?php endif; ?>" name="name" id="firstName" value="<?=$student['name']?>" required>
                                <?php if(isset($name_error)): ?>
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <?php if(isset($surname_error)): ?>
                                    is-invalid
                                <?php endif; ?>" name="surname" id="lastName" value="<?=$student['surname']?>" required>
                                <?php if(isset($surname_error)): ?>
                                    <div class="invalid-feedback">
                                        <?=$surname_error?>
                                    </div>
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <?php if(isset($fathername_error)): ?>
                                    is-invalid
                                <?php endif; ?>" name="fathername" id="fatherName" value="<?=$student['fathername']?>" required>
                                <?php if(isset($fathername_error)): ?>
                                    <div class="invalid-feedback">
                                        <?=$fathername_error?>
                                    </div>
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <?php if(isset($grade_error)): ?>
                                    is-invalid
                                <?php endif; ?>" name="grade" id="grade"value="<?=$student['grade']?>" required>
                                <?php if(isset($grade_error)): ?>
                                    <div class="invalid-feedback">
                                        <?=$grade_error?>
                                    </div>
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <?php if(isset($mobilenumber_error)): ?>
                                    is-invalid
                                <?php endif; ?>" name="mobilenumber" id="mobileNumber" value="<?=$student['mobilenumber']?>" required>
                                <?php if(isset($mobilenumber_error)): ?>
                                    <div class="invalid-feedback">
                                        <?=$mobilenumber_error?>
                                    </div>
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <?php if(isset($birthday_error)): ?>
                                    is-invalid
                                <?php endif; ?>" name="birthday" id="dateOfBirth" value="<?=$student['birthday']?>" required>
                                <?php if(isset($birthday_error)): ?>
                                    <div class="invalid-feedback">
                                        <?=$birthday_error?>
                                    </div>
