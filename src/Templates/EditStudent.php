        ...
        <div class="row">
            <div class="col">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="name" id="firstName" value="<?=$student['name']?>" required>
                </div>
            </div>
            <div class="col">
                <div class="form-group">
                    <label for="lastName">Last Name</label>
                    <input type="text" class="form-control" name="surname" id="lastName" value="<?=$student['surname']?>" required>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="fathername" id="fatherName" value="<?=$student['fathername']?>" required>
                </div>
            </div>
            <div class="col">
                <div class="form-group">
